...
function WPSanitizeTitle(title) {
  var diacriticsMap;
  return removeSingleTrailingDash(replaceSpacesWithDash(removeAccents(
  // Strip any HTML tags.
...
const attributes = {
  ...
  id: {
    type: 'string',
    default: (0,uuid__WEBPACK_IMPORTED_MODULE_0__["default"])()
  }
};
...
const Edit = props => {
  ...
  return currentTabSelected === index ? /*#__PURE__*/React.createElement("section", {
    index: index + 1,
...
const v1 = props => {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("li", {
      ...
      role: "tab",
      id: (0,_helper__WEBPACK_IMPORTED_MODULE_0__["default"])(singleTitle),
...
const Edit = props => {
  ...
  const tabs = attributes.tabs,
    initialTabSelected = attributes.initialTabSelected,
    className = attributes.className,
    sideTabLayout = attributes.sideTabLayout,
    styleString = attributes.styleString,
    blockInitialized = attributes.blockInitialized;
  ...
  const renderToolbar = key => {
    return currentTabSelected === key ? /*#__PURE__*/React.createElement("div", {
  ...
  return /*#__PURE__*/React.createElement("section", blockProps, /*#__PURE__*/React.createElement("ul", {
    className: "ubc-accordion-tabs__tab-list",
    role: "tablist"
    ...
    return /*#__PURE__*/React.createElement("li", {
      role: "presentation",
      key: key
    }, isSelected ? renderToolbar(key) : null, /*#__PURE__*/React.createElement("button", {
      role: "tab",
      id: `tab${key}`,
  ...
  })), /*#__PURE__*/React.createElement(_context__WEBPACK_IMPORTED_MODULE_1__["default"].Provider, {
    value: {
      currentTabSelected,
      childTabIds,
      tabs
    ...
    title: "Settings",
    initialOpen: true
  }, /*#__PURE__*/React.createElement(PanelRow, null, "Initial tab selected"), /*#__PURE__*/React.createElement(ButtonGroup, {
    style: {
      marginTop: '10px'
    }
  }, tabs.map((tab, index) => {
  ...
  })), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement(PanelRow, null, "Tab Format"), /*#__PURE__*/React.createElement(ToggleControl, {
  ...
  }), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement(PanelRow, null, "Style options"), /*#__PURE__*/React.createElement(SelectControl, {
...
const Save = props => {
  ...
  return /*#__PURE__*/React.createElement("section", _extends({
    "data-selected-tab": initialTabSelected
  }, blockProps), /*#__PURE__*/React.createElement("ul", {
    className: "ubc-accordion-tabs__tab-list",
    role: "tablist"
  }, tabs.map((singleTab, key) => {
    return /*#__PURE__*/React.createElement("li", {
